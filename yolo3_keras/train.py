...
from utils1.utils1 import get_random_data
...
if __name__ == "__main__":
    ...
    annotation_path = 'air.txt'
    # 获取classes和anchor的位置
    #classes_path = 'model_data/voc_classes.txt'
    classes_path = 'model_data/aircraft.txt'
    ...
    #model.load_weights('./logs/trained_weights_stage_1.h5')
    model.load_weights('./aircraft_logs/trained_weights_stage_1.h5')
